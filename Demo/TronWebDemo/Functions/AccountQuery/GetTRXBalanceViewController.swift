...
class GetTRXBalanceViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        // Query Button
        queryButton.setTitle("Query Balance", for: .normal)
        ...
        Task {
            if tronWeb.isGenerateTronWebInstanceSuccess != true {
                ...
                do {
                    ...
                    await executeGetBalance(address: address)
                } catch {
    ...
    private func executeGetBalance(address: String) async {
        queryButton.isEnabled = false
        resultTextView.text = "Querying balance..."
        
        let response = await tronWeb.getTRXBalanceAsync(address: address)
