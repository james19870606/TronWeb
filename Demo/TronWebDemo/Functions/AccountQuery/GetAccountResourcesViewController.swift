...
class GetAccountResourcesViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        // Query Button
        queryButton.setTitle("Get Resources (Energy/Bandwidth)", for: .normal)
        ...
        Task {
            if tronWeb.isGenerateTronWebInstanceSuccess != true {
                ...
                do {
                    ...
                    await executeGetResources(address: address)
                } catch {
    ...
    private func executeGetResources(address: String) async {
        queryButton.isEnabled = false
        resultTextView.text = "Fetching resources..."
        
        let response = await tronWeb.getAccountResourcesAsync(address: address)
