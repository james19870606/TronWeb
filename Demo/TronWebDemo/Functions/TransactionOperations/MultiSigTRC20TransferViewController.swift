...
class MultiSigTRC20TransferViewController: UIViewController {
        ...
        Task {
            ...
            if tronWeb.isGenerateTronWebInstanceSuccess != true {
                do {
                    ...
                    await executeEstimate(contract: contract, fromAddress: fromAddress, toAddress: toAddress, amount: amount, privateKeysCount: privateKeysCount, permissionId: permissionId, remark: remark)
                } catch {
    ...
    private func executeEstimate(contract: String, fromAddress: String, toAddress: String, amount: Double, privateKeysCount: Int, permissionId: Int, remark: String) async {
        let response = await self.tronWeb.estimateMultiSigTrc20FeeAsync(contractAddress: contract, fromAddress: fromAddress, toAddress: toAddress, amount: amount, privateKeysCount: privateKeysCount, permissionId: permissionId, remark: remark)
        self.estimateButton.isEnabled = true
    ...
    @objc private func handleTransfer() {
        ...
        Task {
            ...
            do {
                ...
                await executeTransfer(contract: contract, fromAddress: fromAddress, toAddress: toAddress, amount: amount, privateKeys: privateKeys, permissionId: permissionId, remark: remark)
            } catch {
                self.resultTextView.text = "TronWeb Setup Failed: \(error.localizedDescription)"
    ...
    private func executeTransfer(contract: String, fromAddress: String, toAddress: String, amount: Double, privateKeys: [String], permissionId: Int, remark: String) async {
        transferButton.isEnabled = false
        resultTextView.text = "Broadcasting multi-sig TRC20 transaction..."
        
        let response = await tronWeb.multiSigTrc20TransferAsync(contractAddress: contract, fromAddress: fromAddress, toAddress: toAddress, amount: amount, privateKeys: privateKeys, permissionId: permissionId, remark: remark)
        self.transferButton.isEnabled = true
