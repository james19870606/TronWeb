...
class MultiSigTRXTransferViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.title = "Multi-Sig TRX Transfer"
        setupUI()
        updateNetworkStatus()
    }
    ...
    private func setupUI() {
        ...
        transferButton.setTitle("Send Multi-Sig TRX", for: .normal)
    ...
    @objc private func handleEstimate() {
        ...
        if fromAddress.isEmpty || toAddress.isEmpty || privateKeysCount < 1 {
            showAlert(message: "Please fill From, To addresses and at least one private key count for estimation")
            return
        }
    ...
    @objc private func handleTransfer() {
        ...
        if fromAddress.isEmpty || toAddress.isEmpty || privateKeys.isEmpty {
